...
const Content = ({ targetRef }: contentType) => {
  useEffect(() => {
    Aos.init({ duration: 1400, once: true });
  }, []);
  return (
    <section className="bg-[#F6F9FE] w-full mt-[100px]" ref={targetRef}>
      {/* mobile-view */}
      ...
      {/* desktop-view */}
      <div className="container hidden ml:block">
        <div className="row justify-content-between align-items-center">
          <div
            className="col-12 col-lg-6 mx-auto text-center d-none d-md-block"
            data-aos="fade-right"
          >
            <img
              src="/image/mobile-banking-app-concept-free-vector1-removebg-preview.png"
              alt="appImage"
              className="md:h-[600px] lg:ms-auto mx-auto max-w-[100%] h-auto align-middle"
            />
          </div>

          <div className="col-12 col-lg-6 mt-10 " data-aos="fade-left">
            <h1 className="text-[40px] font-semibold mb-10 leading-[49px]">
